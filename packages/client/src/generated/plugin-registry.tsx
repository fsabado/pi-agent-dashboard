...
import { SessionFlowActionsClaim, shouldRenderFlowsSubcard, FlowDashboardClaim, FlowSummaryClaim, FlowYamlPreviewClaim, isFlowYamlPreviewActive, FlowAgentPopoutClaim } from "@blackbelt-technology/pi-dashboard-flows-plugin";
...
export const PLUGIN_REGISTRY: RegistryEntry[] = [
  ...
  },
  {
    ...
    claims: [
      ...
      { pluginId: "flows", priority: 100, slot: "content-header-sticky", Component: FlowSummaryClaim },
      ...
      { pluginId: "flows", priority: 100, slot: "shell-overlay-route", path: "/session/:sid/architect", sessionParam: "sid", Component: FlowAgentPopoutClaim },
    ],
  },
  {
    manifest: {
...
export const PLUGIN_REGISTRY_HASH = "fd98744777d802799f6c4ed2aab6120559c616550e7afa979e204c2e54aca3b2";
