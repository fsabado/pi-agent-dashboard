...
export function MobileShell({ depth, listPanel, detailPanel, onBack }: Props) {
  ...
  return (
    <div ref={containerRef} className="relative w-screen flex-1 min-h-0 overflow-hidden bg-[var(--bg-primary)]" style={{ contain: 'layout', paddingBottom: 'env(safe-area-inset-bottom)' }}>
